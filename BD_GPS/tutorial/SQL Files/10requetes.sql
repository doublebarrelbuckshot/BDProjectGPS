...
-- 4. Selectionner tous les particuliers qui detient que des entites mobiles vivants ( ne détiennent pas d'entite artificiel)
...
-- 5. Selectionner tous les particuliers qui detient que des entites mobiles artificiels ( ne détiennent pas d'entite vivante)
select distinct Particulier.nom from Particulier, Vivant, Adopte, Artificiel, entiteMobile
	where
		Particulier.particulierID = Adopte.particulierID and
		entiteMobile.entiteID = Adopte.entiteID and
